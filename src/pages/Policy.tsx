...
const Policy = () => {
  return (
    <div id="policyContainer">
      ...
      <br />
      <p style={{ paddingBottom: '56px', color: '#4d4d4d' }}>*이 개인정보처리방침은 2022년 9월 24일부터 적용됩니다.</p>
      <h2 className="clauseTitle">
        제1조 (개인정보의 처리 목적)
        <p>
          &lt;탭플레이스&gt;('https://www.tapplace.co.kr'이하 '탭플레이스')은(는) 다음의 목적을 위하여 개인정보를
          처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는
      ...
      <h2 className="clauseTitle">
        ...
        <p>
          ...
          <div className="tab">
            1. 탭플레이스 애플리케이션 내에서 서비스 이용 해지시 사용자로부터 수집받은 데이터 중, 아래에 기재된 데이터를
            서버에서 즉시 삭제합니다.
            <ul>
            ...
            <br />
            3. 애플리케이션 내에서 서비스 이용 해지 절차를 이행하지 못한경우 전자우편, 서면, 연락 등으로 개인정보 파기를
            요청할 수 있습니다.
          </div>
        </p>
      </h2>
      <h2 className="clauseTitle">
        ...
        <p>
          ① 정보주체는 탭플레이스에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
          ...
          합니다.
          <br />④ 개인정보 열람 및 처리정지 요구는 「개인정보 보호법」 제35조 제4항, 제37조 제2항에 의하여 정보주체의
          권리가 제한 될 수 있습니다.
          <br />⑤ 개인정보의 정정 및 삭제 요구는 다른 법령에서 그 개인정보가 수집 대상으로 명시되어 있는 경우에는 그
          삭제를 요구할 수 없습니다.
          <br />⑥ 탭플레이스은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를
      ...
      <h2 className="clauseTitle">
        ...
        <p>
          ...
          <div className="tab">
            ...
            사용하고 있습니다.
            <br />
            4. 개인정보에 대한 접근 제한개인정보를 처리하는 데이터베이스시스템에 대한 접근권한의 부여,변경,말소를 통하여
      ...
      <h2 className="clauseTitle">
        ...
        <p>
          ① 탭플레이스 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리
          ...
          ② 정보주체께서는 탭플레이스 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리,
          피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 탭플레이스은(는) 정보주체의
