    ...
    <div id="policyContainer">
      ...
      <h2 className="clauseTitle">
        ...
        <table>
          ...
          <tr>
            ...
            <td>필수항목 : 사용자 디바이스 고유번호(UUID), 접속 로그</td>
            <td>
      ...
      <h2 className="clauseTitle">
        ...
        <p>
          ...
          <br />② 제1항에 따른 권리 행사는탭플레이스에 대해 「개인정보 보호법」
          시행령 제41조제1항에 따라 서면, 전자우편등을 통하여 하실 수 있으며
          탭플레이스은(는) 이에 대해 지체 없이 조치하겠습니다.
          <br />③ 제1항에 따른 권리 행사는 정보주체의 법정대리인이나 위임을 받은
          자 등 대리인을 통하여 하실 수 있습니다.이 경우 “개인정보 처리 방법에
          ...
          <br />⑥ 탭플레이스은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
      ...
      <h2 className="clauseTitle">
        ...
        <p>
          ...
          <div className="tab">
            ...
            <br />
            3. 접속기록의 보관 및 위변조 방지개인정보처리시스템에 접속한 기록을
            ...
            <br />
            4. 개인정보에 대한 접근 제한개인정보를 처리하는 데이터베이스시스템에
      ...
      <h2 className="clauseTitle">
        ...
        <p>
          ...
          ② 정보주체께서는 탭플레이스 의 서비스(또는 사업)을 이용하시면서 발생한
          모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
          개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다.
          탭플레이스은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴
          것입니다.
        </p>
      </h2>
      <h2 className="clauseTitle">
