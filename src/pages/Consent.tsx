    ...
    <div id="consentContainer">
      ...
      <h2 className="clauseTitle">
        ...
        <p>
          ...
          <div className="tap">
            ...
            <br />
            3. “결제수단"이라 함은 “앱"을 통해 제공되는 서비스 정보(네이버페이, 카카오페이, 제로페이, 페이코, 애플페이,
      ...
      <h2 className="clauseTitle">
        ...
        <p>
          ...
          이전부터 “앱” 내 또는 그 연결화면에 게시하여 이용자에게 공지합니다. 다만, 변경된 내용이 이용자에게 불리하거나
          중대한 사항의 변경인 경우에는 그 적용일 30일 이전까지 본문과 같은 방법으로 공지합니다. 이 경우 개정 전 내용과
          ...
          동의한 것으로 볼 수 있다는 내용도 함께 공지 또는 통지를 하며, 이용자가 이 약관 시행일까지 거부의 의사표시를
          하지 않는다면 개정약관에 동의한 것으로 볼 수 있습니다. 이용자가 개정약관에 대해 동의하지 않는 경우 당사 또는
      ...
      <h2 className="clauseTitle">
        제5조 (이용자 등록)
        <p>
          ① 이용자는 “앱”에서 약관을 동의하여 “앱”에서 정한 양식에 따라 이용자 정보를 기입을 하면, 당사는 이러한 신청을
          승낙하여 이용자 등록이 완료 됩니다.
          <br />② 당사는 원칙적으로 전 항에 따라 이용자 등록에 대하여 승낙함을 원칙으로 합니다.
          <br />③ 이용자는 가입시 등록한 이용자정보의 변경이 발생한 경우, 즉시 전자우편 등을 통하여 당사로 변경을 요청할
          수 있습니다.
        </p>
      </h2>
      <h2 className="clauseTitle">
        제6조 (서비스 이용 해지)
        <p>
          ① 이용자는 서비스 이용을 원하지 않는 경우 언제든지 서비스 이용 해지를 할 수 있으며, 이 경우 “앱”내에 저장된
          이용 기록은 즉시 삭제되며, 당사에 저장되어있는 개인정보 또한 삭제됩니다. 삭제가 진행 된 이후 복구가 불가능하게
          됩니다.
          <br />② 당사는 이용자가 이 약관이 금지하거나 공서양속에 반하는 행위를 하는 등 본 계약을 유지할 수 없는 중대한
          사유가 있는 경우에는 이용자에게 통지하고, 서비스 이용을 제한․중지하거나 이용자 자격을 상실시킬 수 있습니다.
          <br />③ 당사가 이용자자격을 상실시키는 경우에는 이용자 등록을 말소합니다. 이 경우 이용자에게 이를 통지하고,
          이용자 등록 말소 전에 소명할 기회를 부여합니다.
          <br />④ 당사는 최근의 서비스 이용일부터 연속하여 1년 동안 당사의 서비스를 이용하지 않은 이용자의 개인정보를
      ...
      <h2 className="clauseTitle">
        ...
        <p>
          ...
          <br />③ 당사는 계속적이고 안정적인 서비스의 제공을 위하여 서비스 개선을 하던 중 설비에 장애가 생기거나 데이터
          등이 멸실, 훼손된 때에는 천재지변, 비상사태, 현재의 기술로는 해결이 불가능한 장애나 결함 등 부득이한 사유가
      ...
      <h2 className="clauseTitle">
        ...
        <p>
          ...
          <div className="tap">
            ...
            <br />
            2. 당사는 이용자에게 별도의 동의를 받은 경우 서비스 이용에 대한 유용한 각종 정보에 대하여 “앱”에 게재하는 것
            이외에 푸시(Push) 알림 등의 방법으로 이용자에게 제공할 수 있습니다. 단, 별도의 동의가 없더라도 당사는 서비스
            이용에 관한 정보나 제휴 매장과 관련한 광고를 “앱”에 게재할 수 있습니다.
            <br />
      ...
      <h2 className="clauseTitle">
        ...
        <p>
          ...
          <br />② 당사가 이용자의 개인식별이 가능한 개인정보 및 계정정보를 수집하는 때에는 반드시 당해 이용자의 동의를
          받습니다.
          <br />③ 당사는 관련 법령에 의하거나, 관련 국가기관 등의 요청이 있는 경우를 제외하고는 이용자의 개인정보를
          본인의 동의 없이 제3자에게 제공하지 않습니다.
          <br />④ 이용자는 언제든지 당사가 가지고 있는 자신의 개인정보에 대해 열람 및 오류정정 또는 동의 철회를 요구할
          수 있으며 당사는 이에 대해 지체 없이 필요한 조치를 취할 의무를 집니다.
      ...
      <h2 className="clauseTitle">
        ...
        <p>
          ...
          <br />③ 서비스와 관련하여 게재된 정보나 자료 등의 신뢰성, 정확성 등에 대하여 당사는 고의 또는 중대한 과실이
          없는 한 책임을 지지 않습니다.
          <br />④ 당사는 무료로 제공되는 서비스 이용과 관련하여 이용자에게 발생한 손해에 대해서는 책임을 지지 않습니다.
          <br />⑤ 당사는 이용자가 서비스를 이용하여 기대하는 이익을 얻지 못하거나 상실한 것에 대하여 책임을 지지
          않습니다.
          <br />⑥ 당사는 이용자가 모바일 기기 등을 관리하지 않아 발생하는 손해에 대해 책임을 지지 않습니다.
          <br />⑦ 이용자가 모바일 기기의 변경, 모바일 기기의 번호 변경, 운영체제(OS) 버전의 변경, 해외 로밍, 통신사 변경
          등으로 인해 콘텐츠 전부나 일부의 기능을 이용할 수 없는 경우 당사는 이에 대해 책임을 지지 않습니다.
          <br />⑧ 이용자가 당사가 제공하는 콘텐츠나 서비스이 이용을 해지한 경우 당사는 이에 대해 책임을 지지 않습니다.
        </p>
      </h2>
      <h2 className="clauseTitle">
        제13조 (저작권 등의 귀속)
        <p>
          ...
          <br />② 이용자는 당사가 제공하는 서비스를 이용하여 얻은 정보 중에서 당사 또는 제공업체에 지식재산권이 귀속된
          정보를 당사 또는 제공업체의 사전 동의 없이 복제⋅전송 등의 방법(편집, 공표, 공연, 배포, 방송, 2차적 저작물 작성
          등을 포함합니다. 이하 같습니다)에 의하여 영리목적으로 이용하거나 타인에게 이용하게 하여서는 안 됩니다. ③ 이
          조는 당사가 서비스를 운영하는 동안 유효하며, 서비스 이용 해지 후에도 지속적으로 적용됩니다.
        </p>
      </h2>
      <h2 className="clauseTitle">
        ...
        <p>
          ...
          안내합니다.
          <br />② 당사는 이용자로부터 제기되는 의견이나 불만이 정당하다고 객관적으로 인정될 경우에는 합리적인 기간 내에
          이를 신속하게 처리합니다. 다만, 처리에 장기간이 소요되는 경우에는 이용자에게 장기간이 소요되는 사유와
