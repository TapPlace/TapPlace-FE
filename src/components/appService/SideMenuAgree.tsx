        ...
        <div id="policyContainer">
          ...
          <h2 className="clauseTitle">
            ...
            <table>
              ...
              <tr>
                <td>
                  필수항목 : 사용자 디바이스 고유번호(UUID), 접속 로그, 단말기
                  운영체제(OS)
                </td>
                <td>
          ...
          <h2 className="clauseTitle">
            ...
            <p>
              ...
              <div className="tab">
                ...
                2. 전자적 파일 형태의 정보는 기록을 재생할 수 없는 기술적 방법을
                사용합니다
                <br />
                3. 애플리케이션 내에서 서비스 이용 해지 절차를 이행하지 못한경우
                전자우편, 서면, 연락 등으로 개인정보 파기를 요청할 수 있습니다.
              </div>
            </p>
          </h2>
          <h2 className="clauseTitle">
            ...
            <p>
              ...
              <br />② 제1항에 따른 권리 행사는탭플레이스에 대해 「개인정보
              보호법」 시행령 제41조제1항에 따라 서면, 전자우편등을 통하여 하실
              수 있으며 탭플레이스은(는) 이에 대해 지체 없이 조치하겠습니다.
              ...
              <br />⑥ 탭플레이스은(는) 정보주체 권리에 따른 열람의 요구,
          ...
          <h2 className="clauseTitle">
            ...
            <p>
              ...
              <div className="tab">
                ...
                대책을 시행하고 있습니다.
                <br />
                2. 내부관리계획의 수립 및 시행개인정보의 안전한 처리를 위하여
                내부관리계획을 수립하고 시행하고 있습니다.
                <br />
                3. 접속기록의 보관 및 위변조 방지개인정보처리시스템에 접속한
                기록을 최소 1년 이상 보관, 관리하고 있으며,다만, 5만명 이상의
                정보주체에 관하여 개인정보를 추가하거나, 고유식별정보 또는
                민감정보를 처리하는 경우에는 2년이상 보관, 관리하고
                있습니다.또한, 접속기록이 위변조 및 도난, 분실되지 않도록
                보안기능을 사용하고 있습니다.
                <br />
                4. 개인정보에 대한 접근 제한개인정보를 처리하는
          ...
          <h2 className="clauseTitle">
            ...
            관한 사항)
            <p>
              탭플레이스 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는
          ...
          <h2 className="clauseTitle">
            ...
            <p>
              ② 탭플레이스 개인정보 처리방침(2022년 09월 16일부터 2022년 09월
              25일까지)
            </p>
          </h2>
        </div>
        ...
        <div id="consentContainer">
          ...
          <h2 className="clauseTitle">
            ...
            <p>
              ...
              "애플리케이션"(이하 "앱"이라고 합니다)의 서비스 이용 및 제공에
          ...
          <h2 className="clauseTitle">
            ...
            <p>
              ...
              <div className="tap">
                ...
                <br />
                3. “결제수단"이라 함은 “앱"을 통해 제공되는 서비스
                정보(네이버페이, 카카오페이, 제로페이, 페이코, 애플페이,
                구글페이, 컨택리스)를 통틀어 말합니다.
                <br />
                4. “모바일 기기”란 콘텐츠를 다운로드 받거나 설치하여 사용할 수
                있는 기기로서, 휴대폰, 스마트폰, 휴대정보단말기(PDA), 태블릿
                등을 의미합니다.
              </div>
          ...
          <h2 className="clauseTitle">
            ...
            <p>
              ...
              공지함으로써 효력이 발생합니다.
              <br />② 당사는 불가피한 여건이나 사정이 있을 경우 「약관의 규제에
              관한 법률」, 「정보통신망이용촉진 및 정보보호 등에 관한 법률」등
              관련 법령에 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.
              <br />③ 당사가 약관을 개정할 경우에는 적용일자 및 개정내용,
              개정사유 등을 명시하여 최소한 그 적용일 7일 이전부터 “앱” 내 또는
              그 연결화면에 게시하여 이용자에게 공지합니다. 다만, 변경된 내용이
              이용자에게 불리하거나 중대한 사항의 변경인 경우에는 그 적용일 30일
              이전까지 본문과 같은 방법으로 공지합니다. 이 경우 개정 전 내용과
              개정 후 내용을 명확하게 비교하여 이용자가 알기 쉽도록 표시합니다.
              <br />④ 당사가 약관을 개정할 경우 개정약관 공지 후 개정약관의
              적용에 대한 이용자의 동의 여부를 확인합니다. 당사는 제3항의 공지
              또는 통지를 할 경우 이용자가 개정약관에 대해 동의 또는 거부의
              의사표시를 하지 않으면 동의한 것으로 볼 수 있다는 내용도 함께 공지
              또는 통지를 하며, 이용자가 이 약관 시행일까지 거부의 의사표시를
              하지 않는다면 개정약관에 동의한 것으로 볼 수 있습니다. 이용자가
              개정약관에 대해 동의하지 않는 경우 당사 또는 이용자는 서비스
              이용계약을 해지할 수 있습니다.
            </p>
          </h2>
          <h2 className="clauseTitle">
            ...
            <p>
              ...
              「약관의 규제에 관한 법률」, 「정보통신망이용촉진 및 정보보호 등에
          ...
          <h2 className="clauseTitle">
            ...
            <p>
              ...
              이용자 정보를 기입을 하면, 당사는 이러한 신청을 승낙하여 이용자
              등록이 완료 됩니다.
              <br />② 당사는 원칙적으로 전 항에 따라 이용자 등록에 대하여
              승낙함을 원칙으로 합니다.
              <br />③ 이용자는 가입시 등록한 이용자정보의 변경이 발생한 경우,
          ...
          <h2 className="clauseTitle">
            ...
            <p>
              ...
              해지를 할 수 있으며, 이 경우 “앱”내에 저장된 이용 기록은 즉시
              삭제되며, 당사에 저장되어있는 개인정보 또한 삭제됩니다. 삭제가
              진행 된 이후 복구가 불가능하게 됩니다.
              <br />② 당사는 이용자가 이 약관이 금지하거나 공서양속에 반하는
              행위를 하는 등 본 계약을 유지할 수 없는 중대한 사유가 있는
              경우에는 이용자에게 통지하고, 서비스 이용을 제한․중지하거나 이용자
              자격을 상실시킬 수 있습니다.
              <br />③ 당사가 이용자자격을 상실시키는 경우에는 이용자 등록을
              말소합니다. 이 경우 이용자에게 이를 통지하고, 이용자 등록 말소
              전에 소명할 기회를 부여합니다.
              <br />④ 당사는 최근의 서비스 이용일부터 연속하여 1년 동안 당사의
              서비스를 이용하지 않은 이용자의 개인정보를 보호하기 위해
              이용계약을 해지하고 이용자의 개인정보를 파기 등의 조치를 취할 수
              있습니다. 이 경우 조치일 30일 전까지 계약 정지 또는 해지, 개인정보
              파기 등의 조치가 취해진다는 사실 및 파기될 개인정보 등을
              이용자에게 통지합니다.
            </p>
          </h2>
          <h2 className="clauseTitle">
            ...
            <p>
              ...
              수 있습니다.
              <br />② 당사는 불특정다수 이용자에 대한 통지의 경우 30일 이상
          ...
          <h2 className="clauseTitle">
            ...
            <p>
              ...
              <div className="tap">
                ...
                도용하여 메일을 발송하는 행위, 다른 이용자 또는 제3자로
                가장하거나 제3자와의 관계를 허위로 명시하는 행위
                <br />
                3. 다른 이용자의 개인정보를 무단으로 수집⋅저장⋅게시 또는
                유포하는 행위
                <br />
                4. 서비스를 무단으로 영리, 영업, 광고, 홍보, 정치활동, 선거운동
                등 본래의 용도 이외의 용도로 이용하는 행위
                <br />
                5. 당사의 서비스를 이용하여 얻은 정보를 무단으로
                복제․유통․조장하거나 상업적으로 이용하는 행위, 알려지거나
                ...
                기타 일체의 권리를 침해하는 행위, 명예를 훼손하거나 모욕, 욕설,
                폭언 등을 하는 행위, 그 외에 손해를 가하는 행위
                <br />
                8. 법령에 의하여 전송 또는 게시가 금지된 정보, 파일 등이나
                컴퓨터 소프트웨어⋅하드웨어 또는 전기통신장비의 정상적인 작동을
                방해⋅파괴할 목적으로 고안된 바이러스⋅컴퓨터 코드⋅파일⋅프로그램
                등을 고의로 전송⋅게시⋅유포 또는 사용하는 행위
                <br />
                9. 당사로부터 특별한 권리를 부여받지 않고 앱을 변경하거나, 앱에
                다른 프로그램을 추가⋅삽입하거나, 서버를 해킹⋅역설계하거나, 소스
                코드나 애플리케이션 데이터를 유출⋅변경하거나, 별도의 서버를
                구축하거나, 웹사이트의 일부분을 임의로 변경⋅도용하여 당사를
                사칭하는 행위
                <br />
          ...
          <h2 className="clauseTitle">
            ...
            <p>
              ...
              <div className="tap">
                ...
                유용한 각종 정보에 대하여 “앱”에 게재하는 것 이외에 푸시(Push)
                알림 등의 방법으로 이용자에게 제공할 수 있습니다. 단, 별도의
                동의가 없더라도 당사는 서비스 이용에 관한 정보나 제휴 매장과
                관련한 광고를 “앱”에 게재할 수 있습니다.
                <br />
                3. 서비스의 이용은 “앱”의 업무상 또는 기술상 특별한 지장이 없는
                한 연중무휴를 원칙으로 합니다. 다만, 정기점검 등의 필요로 인하여
                당사가 정한 날 및 시간에 대해서는 예외로 합니다.
                <br />
                4. 당사는 “앱” 시스템 등의 보수, 점검, 교체, 시스템의 고장,
          ...
          <h2 className="clauseTitle">
            ...
            <p>
              ...
              <br />③ 당사는 관련 법령에 의하거나, 관련 국가기관 등의 요청이
              있는 경우를 제외하고는 이용자의 개인정보를 본인의 동의 없이
              제3자에게 제공하지 않습니다.
              <br />④ 이용자는 언제든지 당사가 가지고 있는 자신의 개인정보에
              대해 열람 및 오류정정 또는 동의 철회를 요구할 수 있으며 당사는
          ...
          <h2 className="clauseTitle">
            ...
            <p>
              ...
              장기간이 소요되는 사유와 처리일정을 서비스 내 공지하거나 제7조에
              따라 통지합니다.
            </p>
          </h2>
          <h2 className="clauseTitle">
            ...
            <p>
              ...
              간에 발생한 분쟁으로 소송이 제기되는 경우에는 법령에 정한 절차에
              따른 법원을 관할 법원으로 합니다.
            </p>
          </h2>
          <h2 className="clauseTitle">
